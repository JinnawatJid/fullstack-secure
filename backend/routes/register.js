...
module.exports = (dbPool) => {
  router.post("/", (req, res) => {
    const { email, password, role } = req.body; // แปลงค่า role ให้ตรงกับ ENUM ในฐานข้อมูล
        ...
        bcrypt.hash(password, 10, (hashError, hashedPassword) => {
          ...
          dbPool.query(
            ...
            (insertError, result) => {
              ...
              const userId = result.insertId; // ดึงข้อมูลผู้ใช้ที่เพิ่งสร้าง
                ...
                (selectError, selectResult) => {
                  if (selectError) {
                    ...
                    return res
                      ...
                      .json({
                        message:
                          "Registration successful but error retrieving user data.",
                      });
                  }
